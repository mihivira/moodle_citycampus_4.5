...
//certificate_print_text($pdf, $x, $y + 55, 'C', 'Helvetica', '', 20, get_string('certify', 'certificate'));
certificate_print_text($pdf, $x, $y + 130, 'C', 'Helvetica', '', 30, fullname($USER));
//certificate_print_text($pdf, $x, $y + 155, 'C', 'Helvetica', '', 20, get_string('statement', 'certificate'));
certificate_print_text($pdf, $x, $y + 235, 'C', 'Helvetica', '', 25, $course->fullname);
certificate_print_text($pdf, $newx, $y + 288, 'L', 'Helvetica', '', 25, ucwords(certificate_get_date($certificate, $certrecord, $course)));
...
if ($certificate->printhours) {
    certificate_print_text($pdf, $x + 500, $y + 288, 'C', 'Helvetica', '', 25, $certificate->printhours);
}
