...
$string['choosereadme'] = 'norte19 is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['configtitle'] = 'norte19';
$string['generalsettings'] = 'General settings';
$string['loginbackgroundimage'] = 'Login page background image';
$string['loginbackgroundimage_desc'] = 'The image to display as a background for the login page.';
$string['pluginname'] = 'norte19';
$string['preset'] = 'Theme preset';
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme.';
$string['presetfiles'] = 'Additional theme preset files';
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme. See <a href="https://docs.moodle.org/dev/norte19_Presets">norte19 presets</a> for information on creating and sharing your own preset files, and see the <a href="https://moodle.net/search?q=boost+presets">Presets repository</a> for presets that others have shared.';
$string['privacy:metadata'] = 'The norte19 theme does not store any personal data about any user.';
...
// norte19page start !DO NOT DELETE !DO NOT CHANGE.
$string['norte19pagestart'] = 'Info Page Settings';
$string['norte19pagestartdesc'] = '';
$string['norte19pageend'] = '--*/*--';
$string['norte19pageenddesc'] = '';
// norte19page.
$string['norte19page'] = 'Info Pages';
$string['norte19pageheading'] = ': Advanced Page Settings';
$string['norte19pageheadingdesc'] = 'This creates of up to six info page for you to promote important elements of your site.';
$string['norte19pageenabled'] = 'Enable norte19page';
$string['norte19pageenableddesc'] = 'Enable a norte19page at the top of your home page';
$string['norte19pagecount'] = 'Page count';
$string['norte19pagecountdesc'] = 'Select how many pages you want to add <strong>then click SAVE</strong> to load the input fields.';
$string['norte19pageno'] = '! Page-{$a->norte19page}';
$string['norte19pagenodesc'] = 'Enter the settings for page {$a->norte19page}. <b><i>PAGE LINK: www.yoursite/local/norte19page/?id=a{$a->norte19page}</i></b>';
$string['norte19pagedesign'] = 'Page design';
$string['norte19pagedesigndesc'] = 'Select the page design you want to add. You can quickly create your pages using a simple design.
                                In a simple design, use only the image and subtitle part.';
$string['norte19pageimage'] = 'Page picture';
$string['norte19pageimagedesc'] = 'Add an image for your page.';
$string['norte19pagetitle'] = 'Page title';
$string['norte19pagetitledesc'] = 'Add the page\'s title.';
$string['norte19pagecaption'] = 'Page caption';
$string['norte19pagecaptiondesc'] = 'Add a caption for your page';
$string['norte19pagecss'] = 'Page css';
$string['norte19pagecssdesc'] = 'Add a css for your page';
$string['norte19pagecsslink'] = 'Page css link';
$string['norte19pagecsslinkdesc'] = 'Add a css link for your page,
            Example : "https://www.exaple.com/abc.css"';
$string['norte19pageimglink'] = 'Page img folder link';
$string['norte19pageimglinkdesc'] = 'Add a img folder link for your page, Copy your images that you use in html to this folder.
...
$string['norte19pagenavbar'] = 'Page navbar';
$string['norte19pagenavbardesc'] = 'Add navbar to info page';
$string['norte19pageheader'] = 'Page header';
$string['norte19pageheaderdesc'] = 'Add header to info page';
$string['norte19pagefooter'] = 'Page footer';
$string['norte19pagefooterdesc'] = 'Add footer to info page';
$string['norte19pagenotfound'] = 'Page not found, please check url';
// norte19page simple.
$string['norte19pageheadingsimple'] = '! Simple Page Settings';
$string['norte19pageheadingsimpledesc'] = 'This creates of up to six info page for you to promote important elements of your site.';
$string['norte19pageenabledsimple'] = 'Enable norte19page';
$string['norte19pageenabledsimpledesc'] = 'Enable a norte19page at the top of your home page';
$string['norte19pagecountsimple'] = 'Page count';
$string['norte19pagecountsimpledesc'] = 'Select how many pages you want to add <strong>then click SAVE</strong> to load the input fields.';
$string['norte19pagenosimple'] = '! Page-{$a->norte19page}';
$string['norte19pagenosimpledesc'] = 'Enter the settings for page {$a->norte19page}. <b><i>PAGE LINK: www.yoursite/local/norte19page/?id=s{$a->norte19page}</i></b>';
$string['norte19pagetitlesimple'] = 'Page title';
$string['norte19pagetitlesimpledesc'] = 'Add the page\'s title.';
$string['norte19pageimagesimple'] = 'Page picture';
$string['norte19pageimagesimpledesc'] = 'Add an image for your page.';
$string['norte19pageimgpositionsimple'] = 'Page picture position';
$string['norte19pageimgpositionsimpledesc'] = 'Where the uploaded image will be located on the page.';
$string['norte19pagecaptionsimple'] = 'Page caption';
$string['norte19pagecaptionsimpledesc'] = 'Add a caption for your page';
$string['norte19pageheadersimple'] = 'Page header';
$string['norte19pageheadersimpledesc'] = 'Add header to info page';
$string['norte19pagefootersimple'] = 'Page footer';
$string['norte19pagefootersimpledesc'] = 'Add footer to info page';
// Button settings.
$string['button'] = 'Button';
$string['buttonlink'] = 'https://themesalmond.com/';
// Theme norte19 settings !DO NOT DELETE !DO NOT CHANGE.
$string['divdiv'] = '</div></div></div>';
$string['div'] = '</div>';
$string['frontpageend'] = '--*/*--';
$string['frontpageenddesc'] = '';
$string['frontpagenorte19'] = 'Front Page';
...
<br><a href="./../theme/norte19/pix/norte19/slide_01.jpg" target="_blank">Click to see blocks</a>';
...
$string['theme_norte19_frontpageblock'] = 'Block';
$string['theme_norte19_frontpageblockheading'] = 'Front Page Blocks';
$string['theme_norte19_frontpageblockdesc'] = 'Front Page HTML blocks settings';
...
$string['block11captiondefault'] = 'Welcome to norte19 blog posts.';
// Frontpage block 12.
...
$string['theme_norte19_frontpageblockend'] = '--*/*--';
$string['theme_norte19_frontpageblockenddesc'] = '';
// Course single page.
...
$string['brandfield'] = 'User brand field';
$string['brandfield_desc'] = 'Name of the custom user profile field that contains the brand information';
$string['gestor_marca'] = 'Brands Management';
$string['gestor_marca_desc'] = 'Configure brands in format: brand_id|Brand Name (one per line)';
$string['logo'] = 'Default Logo';
$string['logodesc'] = 'Upload default logo here';
$string['brandcolor'] = 'Default Brand Color';
$string['brandcolor_desc'] = 'The main brand color';
$string['backcolor'] = 'Default Background Color';
$string['backcolor_desc'] = 'The background color';
$string['navbarcolor'] = 'Default Navbar Color';
$string['navbarcolor_desc'] = 'The navigation bar color';
$string['sitecolor'] = 'Default Site Color';
$string['sitecolor_desc'] = 'The main site color';
$string['scsspre'] = 'Pre SCSS';
$string['scsspre_desc'] = 'Custom SCSS code to prepend';
$string['customcss'] = 'Custom CSS';
$string['customcss_desc'] = 'Additional CSS rules';
...
foreach ($marcas as $marcaid => $marcaname) {
    // Brand logo.
    $name = "theme_norte19/{$marcaid}logo";
    // Placeholder strings for brand settings
    $string["{$marcaid}logo"] = "{$marcaname} Logo";
    $string["{$marcaid}logo_desc"] = "Upload logo for {$marcaname}";
    $string["{$marcaid}color"] = "{$marcaname} Color";
    $string["{$marcaid}color_desc"] = "Main color for {$marcaname}";
    $string["{$marcaid}backcolor"] = "{$marcaname} Background";
    $string["{$marcaid}backcolor_desc"] = "Background color for {$marcaname}";
    $string["{$marcaid}navbarcolor"] = "{$marcaname} Navbar Color";
    $string["{$marcaid}navbarcolor_desc"] = "Navbar color for {$marcaname}";
    $string["{$marcaid}sitecolor"] = "{$marcaname} Site Color";
    $string["{$marcaid}sitecolor_desc"] = "Site color for {$marcaname}";
