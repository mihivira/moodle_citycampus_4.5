 ...
 * @return url
 */
function theme_norte19_frontpageblock01() {
 ...
 * @return url
 */
function theme_norte19_frontpageblock02() {
    global $OUTPUT;
    ...
    for ($i = 1, $j = 0; $i <= $count; $i++, $j++) {
        ...
        if (empty($image)) {
            $image = $OUTPUT->image_url('norte19/block02/'.$i, 'theme');
        }
 ...
 * @return url
 */
function theme_norte19_frontpageblock03() {
    global $OUTPUT;
    $theme = theme_config::load('norte19');
 ...
 * @return url
 */
function theme_norte19_frontpageblock04() {
    global $OUTPUT;
    $theme = theme_config::load('norte19');
    ...
    for ($i = 1, $j = 0; $i <= $count; $i++, $j++) {
        ...
        if (empty($image)) {
            $image = $OUTPUT->image_url('norte19/block04/'.$i, 'theme');
        }
        if ($i == 1) {
 ...
 * @return url
 */
function theme_norte19_frontpageblock05() {
    global $OUTPUT;
    ...
    if (empty($image)) {
        $image = $OUTPUT->image_url('norte19/block05/1', 'theme');
    }
 ...
 * @return url
 */
function theme_norte19_frontpageblock06() {
    global $OUTPUT;
    ...
    if (empty($image)) {
        $image = $OUTPUT->image_url('norte19/block06/1', 'theme');
    }
 ...
 * @return url
 */
function theme_norte19_frontpageblock07() {
    ...
    if (!empty($allcourses)) {
        foreach ($allcourses as $id => $course) {
            ...
            $templatecontext['block07'][$j]['imgurl'] = norte19_get_course_image($id);
            $enrol = $DB->get_records_sql($sql, ['courseid' => $id]);
            if (empty($enrol)) {
                $templatecontext['block07'][$j]['currency'] = get_string('block07enrol', 'theme_norte19');
            } else {
 ...
 * @return url
 */
function theme_norte19_frontpageblock08() {
 ...
 * @return url
 */
function theme_norte19_frontpageblock09() {
    GLOBAL $CFG, $DB;
    ...
    if (!empty($categorys)) {
        ...
        foreach ($categorys as $category) {
            ...
            if ($theme->settings->block09background == '1') {
                $templatecontext['block09'][$j]['bgcolor'] = theme_norte19_random_color();
            }
            ...
            if ($theme->settings->block09background == '2') {
                ...
                if (!empty($courses)) {
                    foreach ($courses as $course) {
                        $imgurl = norte19_get_course_image($course->id);
                        if (!empty($imgurl)) {
 ...
 * @return url
 */
function theme_norte19_frontpageblock10() {
    global $OUTPUT;
    ...
    for ($i = 1, $j = 0; $i <= $count; $i++, $j++) {
        ...
        if (empty($image)) {
            $image = $OUTPUT->image_url('norte19/block10/'.$i, 'theme');
        }
 ...
 * @return url
 */
function theme_norte19_frontpageblock11() {
    // Site blog frontpage.
    ...
    if (!empty($posts)) {
        ...
        foreach ($posts as $post) {
            ...
            $templatecontext['block11'][$j]['imgurl'] = norte19_get_blog_post_image($post->id);
 ...
 * @return url
 */
function theme_norte19_frontpageblock18() {
    $theme = theme_config::load('norte19');
 ...
 * @return url
 */
function theme_norte19_frontpageblock19() {
    global $OUTPUT;
    $theme = theme_config::load('norte19');
    ...
    for ($i = 1; $i <= 6; $i++) {
        ...
        if (empty($image)) {
            $image = $OUTPUT->image_url('norte19/block19/'.$i, 'theme');
        }
        if (!empty($image)) {
 ...
 * @return url
 */
function theme_norte19_frontpageblock20() {
    global $OUTPUT;
    ...
    $templatecontext['block20col2links'] = theme_norte19_links($theme->settings->block20col2link);
    $templatecontext['block20col3header'] = format_string($theme->settings->block20col3header);
    $templatecontext['block20col3links'] = theme_norte19_links($theme->settings->block20col3link);
