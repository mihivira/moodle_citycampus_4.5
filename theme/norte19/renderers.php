...
/**
 *  Theme norte19 course render.
 */
class theme_norte19_core_course_renderer extends core_course_renderer {
    /**
...
/**
 *  Theme norte19 blog render.
 */
class theme_norte19_core_blog_renderer extends core_blog_renderer {
    /**
    ...
    public function render_blog_entry(blog_entry $entry) {
        ...
        // Header.
        $mainclass = 'forumpost blog_entry blog clearfix norte19-blog ';
        ...
        // Post content.
        $o .= $this->output->container_start('row maincontent clearfix norte19-blog-post');
        ...
        $o .= $this->output->container_start('norte19-blog-header row header clearfix');
    ...
    public function render_blog_entry_attachment(blog_entry_attachment $attachment) {
        ...
        if (file_mimetype_in_typegroup($attachment->file->get_mimetype(), 'web_image')) {
            ...
            $class = 'norte19-blog-img attachedimages';
        } else {
