...
$page = new admin_settingpage('theme_norte19_block', get_string('theme_norte19_frontpageblock', 'theme_norte19'));
...
// Block end.
$page->add(new admin_setting_heading('theme_norte19_blockend', get_string('theme_norte19_frontpageblockend', 'theme_norte19'),
format_text(get_string('theme_norte19_frontpageblockenddesc', 'theme_norte19'), FORMAT_MARKDOWN)));
$settings->add($page);
